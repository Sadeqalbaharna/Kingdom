      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            FilledButton.icon(onPressed: () => _addDebt(context), icon: const Icon(Icons.add), label: const Text('Add')),
          ],
        ),
        ...
        // Debts list
        ...s.debts.map((d) {
          final hp = ((d.balance / d.original) * 100).clamp(0, 100).round();
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Chip(label: Text('HP $hp%'), backgroundColor: Colors.red.withOpacity(0.1), labelStyle: const TextStyle(color: Colors.red)),
